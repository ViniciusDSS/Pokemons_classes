 ...
 * @author Samsung
 */
public class Lutar extends javax.swing.JFrame {

    /**
     * Creates new form Lutar
     */
    public Lutar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        charmander.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ac1pokemons/Pics/charmander.png"))); // NOI18N
        getContentPane().add(charmander);
        charmander.setBounds(80, 190, 70, 130);
        ...
        Pikachu.setBounds(240, 200, 96, 96);
        ...
        jButton1.setBounds(140, 30, 120, 23);
    ...
    pokemons MyPokemon = new pokemons("Charmander", "Fogo", 1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lutar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
